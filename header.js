function navbar(){
  return  ` <div id="div1">
    ...
    <ul id="ul2" class="one-sdv">
        <li><a class="ancr" href="putlogin.html"><span id="change_name">LOGIN</span></a></li>
        ...
        <li><i class="ancr" class="fas fa-shopping-cart"></i><a class="wishlis" href="putcart.html" >CART(0)</a></li>
    </ul>
  </div>
                ...
                <div class="dropdown-content">
                    ...
                    <div class="row">
                        ...
                        <div class="column">
                            ...
                            <a href="#">CROWNS</a>
                            <a href="putearrings.html">EARRINGS</a>
                            <a href="#">HAIRPINS</a>
                            <a href="#">NECKLACE</a>
                            <a href="#">TORC</a>
                            <a href="#">BRACELET</a>
